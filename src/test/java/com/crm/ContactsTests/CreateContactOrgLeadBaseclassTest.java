...
public class CreateContactOrgLeadBaseclassTest extends BaseClass{
	

	@Test
	public void createContactOrgLeadWithPOM() throws Throwable {
			...
			String lead = eLib.readDataFromExcel("Contact", 6, 3);
			...
			ccp.createNewContact(driver, lastName, OrgName, lead);
